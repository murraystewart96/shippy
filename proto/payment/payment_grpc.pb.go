...
const (
	PaymentService_Authorise_FullMethodName = "/payment.PaymentService/Authorise"
	PaymentService_Capture_FullMethodName   = "/payment.PaymentService/Capture"
	PaymentService_Refund_FullMethodName    = "/payment.PaymentService/Refund"
	PaymentService_Void_FullMethodName      = "/payment.PaymentService/Void"
)
...
func (c *paymentServiceClient) Authorise(ctx context.Context, in *AuthoriseRequest, opts ...grpc.CallOption) (*AuthoriseResponse, error) {
...
func (UnimplementedPaymentServiceServer) Authorise(context.Context, *AuthoriseRequest) (*AuthoriseResponse, error) {
...
func _PaymentService_Authorise_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Authorise(ctx, req.(*AuthoriseRequest))
	}
